...
public class FavoriteFragmentDirections {
  ...
  @NonNull
  public static ActionFavoriteFragmentToPlaylistFragment actionFavoriteFragmentToPlaylistFragment(
      @NonNull Album album) {
    return new ActionFavoriteFragmentToPlaylistFragment(album);
  }

  public static class ActionFavoriteFragmentToPlaylistFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionFavoriteFragmentToPlaylistFragment(@NonNull Album album) {
      if (album == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFavoriteFragmentToPlaylistFragment setAlbum(@NonNull Album album) {
      if (album == null) {
        throw new IllegalArgumentException("Argument \"album\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("album", album);
    ...
    public int getActionId() {
      return R.id.action_favoriteFragment_to_playlistFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFavoriteFragmentToPlaylistFragment that = (ActionFavoriteFragmentToPlaylistFragment) object;
    ...
    public String toString() {
      return "ActionFavoriteFragmentToPlaylistFragment(actionId=" + getActionId() + "){"
          + "album=" + getAlbum()
          + "}";
    }
  }
